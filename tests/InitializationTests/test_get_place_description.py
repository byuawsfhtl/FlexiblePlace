...
class TestGetPlaceDescription:
    ...
    def test_country_by_itself(self):
        ...
        flexible_place = asyncio.run(FlexiblePlace.online("Venezuela"))
    ...
    def test_city_county_state_country(self):
        ...
        flexible_place = asyncio.run(FlexiblePlace.online("Eagle, Ada, Idaho, United States"))
    ...
    def test_preset_place_description(self):
        ...
        flexible_place = asyncio.run(FlexiblePlace.online("La Pastora, Libertador, Distrito Capital, Venezuela", "2107883"))
    ...
    def test_different_specificity_can_map_to_same_location(self):
        ...
        more_specific_flexible_place = asyncio.run(FlexiblePlace.online("Mérida, Libertador, Mérida, Venezuela"))
        less_specific_flexible_place = asyncio.run(FlexiblePlace.online("Mérida, Mérida, Venezuela"))
    ...
    def test_place_matches_with_different_named_place(self):
        ...
        flexible_place = asyncio.run(FlexiblePlace.online("Moses Lake, Washington, United States"))

        assert flexible_place.place_description == "5197325"

    def test_null_input(self):
        """Empty string should be handled gracefully."""
        flexible_place = asyncio.run(FlexiblePlace.online(""))
    ...
    def test_string_with_numbers(self):
        ...
        flexible_place = asyncio.run(FlexiblePlace.online("Encino 75, Texas, United States"))
    ...
    def test_string_with_apostrophe(self):
        ...
        flexible_place = asyncio.run(FlexiblePlace.online("Saint John's, Newfoundland, Canada"))
    ...
    def test_string_with_hyphens(self):
        ...
        flexible_place = asyncio.run(FlexiblePlace.online("Winston-Salem, North Carolina, United States"))
    ...
    def test_fake_place(self):
        ...
        flexible_place = asyncio.run(FlexiblePlace.online("Fakeville, Nonexistent, Country"))
